...
#ifndef MOTHERBOARD
  #define MOTHERBOARD BOARD_MIXWARE_HYPER_S_V2_2
#endif
 ...
 *
 *   PRUSA_MMU1      : PrÅ¯Å¡a MMU1 (The "multiplexer" version)
 *   PRUSA_MMU2      : PrÅ¯Å¡a MMU2
 *   PRUSA_MMU2S     : PrÅ¯Å¡a MMU2S (Requires MK3S extruder with motion sensor, EXTRUDERS = 5)
 *   SMUFF_EMU_MMU2  : Technik Gegg SMUFF (PrÅ¯Å¡a MMU2 emulation mode)
 *   SMUFF_EMU_MMU2S : Technik Gegg SMUFF (PrÅ¯Å¡a MMU2S emulation mode)
 *
...
//#define PSU_NAME "Power Supply"
  ...
  //#define AUTO_POWER_CONTROL      // Enable automatic control of the PS_ON pin
    ...
    //#define AUTO_POWER_E_TEMP        50 // (Â°C) Turn on PSU if any extruder is over this temperature
    //#define AUTO_POWER_CHAMBER_TEMP  30 // (Â°C) Turn on PSU if the chamber is over this temperature
 ...
 *   502 : 100K Zonestar Thermistor used by hot bed in Zonestar PrÅ¯Å¡a P802M
 ...
 *         NOTE: ADC pins are not 5V tolerant. Not recommended because it's possible to damage the CPU by going over 500Â°C.
...
//#define MAX31865_SENSOR_OHMS_0      100   // (Î©) Typically 100 or 1000 (PT100 or PT1000)
//#define MAX31865_CALIBRATION_OHMS_0 430   // (Î©) Typically 430 for AdaFruit PT100; 4300 for AdaFruit PT1000
...
#define TEMP_HYSTERESIS          4  // (Â°C) Temperature proximity considered "close enough" to the target
...
#define TEMP_BED_HYSTERESIS      4  // (Â°C) Temperature proximity considered "close enough" to the target
 ...
 *                                      X, Y, Z, E0 [, E1[, E2...]]
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 160, 160, 800, 820 } //  { 80, 80, 400, 320 }
 ...
 */
#define Z_MIN_PROBE_PIN PA15 // Pin 32 is the RAMPS default
 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET { 0, -5, 0 }
...
//#define DEBUG_LEVELING_FEATURE
  ...
  //#define G26_MESH_VALIDATION
    ...
    #define MESH_TEST_HOTEND_TEMP  205    // (Â°C) Default nozzle temperature for G26.
    #define MESH_TEST_BED_TEMP      60    // (Â°C) Default bed temperature for G26.
...
/**
 * Info Screen Style (0:Classic, 1:PrÅ¯Å¡a)
 *
 * :[0:'Classic', 1:'PrÅ¯Å¡a']
 */
...
//
// MKS OLED 1.3" 128Ã—64 FULL GRAPHICS CONTROLLER
...
//
// Zonestar OLED 128Ã—64 FULL GRAPHICS CONTROLLER
//
...
//
// FYSETC OLED 2.42" 128Ã—64 FULL GRAPHICS CONTROLLER with WS2812 RGB
