...
#define TFT_MIXWARE_UI
// #define TFT_COLOR_UI_PORTRAIT
#define TFT_MIXWARE_UI_VERSION "V1.3.013"
 ...
 *
 * Pr??a Calculator:    https://blog.prusaprinters.org/calculator_3416/
 *
...
#ifndef MOTHERBOARD
  #define MOTHERBOARD BOARD_MIXWARE_HYPER_S
#endif
 ...
 *
 *   PRUSA_MMU1           : Pr??a MMU1 (The "multiplexer" version)
 *   PRUSA_MMU2           : Pr??a MMU2
 *   PRUSA_MMU2S          : Pr??a MMU2S (Requires MK3S extruder with motion sensor, EXTRUDERS = 5)
 *   EXTENDABLE_EMU_MMU2  : MMU with configurable number of filaments (ERCF, SMuFF or similar with Pr??a MMU2 compatible firmware)
 *   EXTENDABLE_EMU_MMU2S : MMUS with configurable number of filaments (ERCF, SMuFF or similar with Pr??a MMU2 compatible firmware)
 *
 ...
 * Temperature Sensors:
 *
 * NORMAL IS 4.7k�� PULLUP! Hotend sensors can use 1k�� pullup with correct resistor and table.
 *
 * ================================================================
 *  Analog Thermistors - 4.7k�� pullup - Normal
 * ================================================================
 *     1 : 100k�� EPCOS - Best choice for EPCOS thermistors
 *   331 : 100k�� Same as #1, but 3.3V scaled for MEGA
 *   332 : 100k�� Same as #1, but 3.3V scaled for DUE
 *     2 : 200k�� ATC Semitec 204GT-2
 *   202 : 200k�� Copymaster 3D
 *     3 : ???��  Mendel-parts thermistor
 *     4 : 10k��  Generic Thermistor !! DO NOT use for a hotend - it gives bad resolution at high temp. !!
 *     5 : 100k�� ATC Semitec 104GT-2/104NT-4-R025H42G - Used in ParCan, J-Head, and E3D, SliceEngineering 300��C
 *   501 : 100k�� Zonestar - Tronxy X3A
 *   502 : 100k�� Zonestar - used by hot bed in Zonestar Pr??a P802M
 *   503 : 100k�� Zonestar (Z8XM2) Heated Bed thermistor
 *   504 : 100k�� Zonestar P802QR2 (Part# QWG-104F-B3950) Hotend Thermistor
 *   505 : 100k�� Zonestar P802QR2 (Part# QWG-104F-3950) Bed Thermistor
 *   512 : 100k�� RPW-Ultra hotend
 ...
 *     8 : 100k�� Vishay 0603 SMD NTCS0603E3104FXT
 *     9 : 100k�� GE Sensing AL03006-58.2K-97-G1
 *    10 : 100k�� RS PRO 198-961
 *    11 : 100k�� Keenovo AC silicone mats, most Wanhao i3 machines - beta 3950, 1%
 *    12 : 100k�� Vishay 0603 SMD NTCS0603E3104FXT (#8) - calibrated for Makibox hot bed
 *    13 : 100k�� Hisens up to 300��C - for "Simple ONE" & "All In ONE" hotend - beta 3950, 1%
 *    14 : 100k��  (R25), 4092K (beta25), 4.7k�� pull-up, bed thermistor as used in Ender-5 S1
 *    15 : 100k�� Calibrated for JGAurora A5 hotend
 *    18 : 200k�� ATC Semitec 204GT-2 Dagoma.Fr - MKS_Base_DKU001327
 *    22 : 100k�� GTM32 Pro vB - hotend - 4.7k�� pullup to 3.3V and 220�� to analog input
 *    23 : 100k�� GTM32 Pro vB - bed - 4.7k�� pullup to 3.3v and 220�� to analog input
 *    30 : 100k�� Kis3d Silicone heating mat 200W/300W with 6mm precision cast plate (EN AW 5083) NTC100K - beta 3950
 *    60 : 100k�� Maker's Tool Works Kapton Bed Thermistor - beta 3950
 *    61 : 100k�� Formbot/Vivedino 350��C Thermistor - beta 3950
 *    66 : 4.7M�� Dyze Design / Trianglelab T-D500 500��C High Temperature Thermistor
 *    67 : 500k�� SliceEngineering 450��C Thermistor
 *    68 : PT100 Smplifier board from Dyze Design
 *    70 : 100k�� bq Hephestos 2
 *    75 : 100k�� Generic Silicon Heat Pad with NTC100K MGB18-104F39050L32
 *  2000 : 100k�� Ultimachine Rambo TDK NTCG104LH104KT1 NTC100K motherboard Thermistor
 *
 * ================================================================
 *  Analog Thermistors - 1k�� pullup
 *   Atypical, and requires changing out the 4.7k�� pullup for 1k��.
 *   (but gives greater accuracy and more stable PID)
 * ================================================================
 *    51 : 100k�� EPCOS (1k�� pullup)
 *    52 : 200k�� ATC Semitec 204GT-2 (1k�� pullup)
 *    55 : 100k�� ATC Semitec 104GT-2 - Used in ParCan & J-Head (1k�� pullup)
 *
 * ================================================================
 *  Analog Thermistors - 10k�� pullup - Atypical
 * ================================================================
 *    99 : 100k�� Found on some Wanhao i3 machines with a 10k�� pull-up resistor
 *
 * ================================================================
 *  Analog RTDs (Pt100/Pt1000)
 * ================================================================
 *   110 : Pt100  with 1k�� pullup (atypical)
 *   147 : Pt100  with 4.7k�� pullup
 *  1010 : Pt1000 with 1k�� pullup (atypical)
 *  1022 : Pt1000 with 2.2k�� pullup
 *  1047 : Pt1000 with 4.7k�� pullup (E3D)
...
// Resistor values when using MAX31865 sensors (-5) on TEMP_SENSOR_0 / 1
  ...
  #define MAX31865_SENSOR_OHMS_0      100 // (��) Typically 100 or 1000 (PT100 or PT1000)
  #define MAX31865_CALIBRATION_OHMS_0 430 // (��) Typically 430 for Adafruit PT100; 4300 for Adafruit PT1000
#endif
...
#define PID_K1 0.95       // Smoothing factor within any PID loop
  ...
  #else
    #define DEFAULT_Kp 13.14
    #define DEFAULT_Ki 0.855
...
#define DEFAULT_AXIS_STEPS_PER_UNIT { 160, 160, 800, 835 }//820
// #define DEFAULT_AXIS_STEPS_PER_UNIT { 320, 320, 1600, 1640 }
 ...
 *                                      X, Y, Z [, I [, J [, K...]]], E0 [, E1[, E2...]]
 */
#define DEFAULT_MAX_FEEDRATE          { 400, 200, 40, 125 }
 ...
 *                                      X, Y, Z [, I [, J [, K...]]], E0 [, E1[, E2...]]
 */
#define DEFAULT_MAX_ACCELERATION      { 10000, 10000, 500, 10000 }
...
/**
 * Info Screen Style (0:Classic, 1:Pr??a)
 *
 * :[0:'Classic', 1:'Pr??a']
 */
