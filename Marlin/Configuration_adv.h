...
//
  ...
  #define BED_CHECK_INTERVAL 5000   // (ms) Interval between checks in bang-bang control
    ...
    #define BED_HYSTERESIS 2        // (Â°C) Only set the relevant heater state when ABS(T-target) > BED_HYSTERESIS
  #endif
#endif
...
//
  ...
  //#define CHAMBER_FAN               // Enable a fan on the chamber
    ...
    #define CHAMBER_FAN_MODE 2        // Fan control mode: 0=Static; 1=Linear increase when temp is higher than target; 2=V-shaped curve.
      ...
      #define CHAMBER_FAN_FACTOR 25   // PWM increase per Â°C above target
    #elif CHAMBER_FAN_MODE == 2
      #define CHAMBER_FAN_BASE  128   // Minimum chamber fan PWM (0-255)
      #define CHAMBER_FAN_FACTOR 25   // PWM increase per Â°C difference from target
    #endif
  #endif
...
#define USE_CONTROLLER_FAN
  ...
  #define CONTROLLER_FAN_PIN PB11        // Set a custom pin for the controller fan
 ...
 */
  ...
  #define TMC_MICROSTEPS     32
    ...
    #define X_MICROSTEPS     TMC_MICROSTEPS        // 0..256
    ...
    #define X2_MICROSTEPS    TMC_MICROSTEPS
    ...
    #define Y_MICROSTEPS     TMC_MICROSTEPS
    ...
    #define Y2_MICROSTEPS    TMC_MICROSTEPS
    ...
    #define Z_MICROSTEPS     TMC_MICROSTEPS
    ...
    #define Z2_MICROSTEPS    TMC_MICROSTEPS
    ...
    #define Z3_MICROSTEPS    TMC_MICROSTEPS
    ...
    #define Z4_MICROSTEPS    TMC_MICROSTEPS
    ...
    #define E0_MICROSTEPS    TMC_MICROSTEPS
    ...
    #define E1_MICROSTEPS    TMC_MICROSTEPS
    ...
    #define E2_MICROSTEPS    TMC_MICROSTEPS
    ...
    #define E3_MICROSTEPS    TMC_MICROSTEPS
    ...
    #define E4_MICROSTEPS    TMC_MICROSTEPS
    ...
    #define E5_MICROSTEPS    TMC_MICROSTEPS
    ...
    #define E6_MICROSTEPS    TMC_MICROSTEPS
    ...
    #define E7_MICROSTEPS    TMC_MICROSTEPS
   ...
   * CHOPPER_PRUSAMK3_24V // Imported parameters from the official PrÅ¯Å¡a firmware for MK3 (24V)
...
/**
 * PrÅ¯Å¡a Multi-Material Unit (MMU)
 ...
 */
  ...
  //#define MMU2_MENUS
    ...
    // This is for PrÅ¯Å¡a MK3-style extruders. Customize for your hardware.
   ...
   */
     ...
     *
     * Support for a PrÅ¯Å¡a (or other) IR Sensor to detect filament near the extruder
