 ...
 */
  ...
  #define THERMAL_PROTECTION_HYSTERESIS 13     // Degrees Celsius
...
// #define FT_MOTION
  ...
  #define FTM_DEFAULT_DYNFREQ_MODE dynFreqMode_Z_BASED // Default mode of dynamic frequency calculation. (Enums in ft_types.h)
  #define FTM_SHAPING_DEFAULT_X_FREQ 56.0f              // (Hz) Default peak frequency used by input shapers.
  #define FTM_SHAPING_DEFAULT_Y_FREQ 47.0f              // (Hz) Default peak frequency used by input shapers.
...
#define INPUT_SHAPING_Y
    ...
    #define SHAPING_FREQ_X  21.5          // (Hz) The default dominant resonant frequency on the X axis.
    #define SHAPING_ZETA_X  0.1f       // Damping ratio of the X axis (range: 0.0 = no damping to 1.0 = critical damping).
  #endif
  #if ENABLED(INPUT_SHAPING_Y)
    #define SHAPING_FREQ_Y  29          // (Hz) The default dominant resonant frequency on the Y axis.
  ...
  #define SHAPING_MAX_FREQ  60        // By default the minimum of the shaping frequencies. Override to affect SRAM usage.
 ...
 */
  ...
  #define _MICROSTEPS      32

  #if AXIS_IS_TMC_CONFIG(X)
    #define X_CURRENT       800        // (mA) RMS current. Multiply by 1.414 for peak current.
    #define X_CURRENT_HOME  X_CURRENT  // (mA) RMS current for sensorless homing
    #define X_MICROSTEPS     _MICROSTEPS        // 0..256
    ...
    #define Y_MICROSTEPS     _MICROSTEPS
    ...
    #define Z_MICROSTEPS     _MICROSTEPS
    ...
    #define E0_MICROSTEPS    _MICROSTEPS
