...
#include "draw_is_freq_settings.h"
...
#define TFT35
    ...
    #define PARA_UI_TURN_BTN_X_SIZE   100
    #define PARA_UI_TURN_BTN_Y_SIZE   50

    #define QRCODE_X 	                20
    #define QRCODE_Y 	                40
    #define QRCODE_WIDTH	            160

    #define SETTING_LABEL_POS_X       7
    #define SETTING_LABEL_POS_Y       -3
  #else
  #define titleHeight        36   // TFT_screen.title_high
  #define INTERVAL_H          2   // TFT_screen.gap_h // 2
  #define INTERVAL_V          2   // TFT_screen.gap_v // 2
...
typedef struct {
  ...
  bool      filament_det_enable;
  int       filament_max_temper;
  int16_t   extru_min_temp;
} CFG_ITMES;
...
typedef enum {
  ...
  GCODE_UI,
  MEDIA_SELECT_UI,
  FILAMENT_TEMPERATURE_SELECT_UI,
  LEVEL_SELECT_UI,
  ADJUST_Z_OFFSET_UI,
  PIDTEMP_SW_UI,
  DEBUG_ZAXIS_UI,
...
extern lv_point_t line_points[6][2];
...
#define PARA_UI_POS_Y 62

#define PARA_UI_SIZE_X (TFT_WIDTH - PARA_UI_POS_X - PARA_UI_POS_X)
...
#define PARA_UI_BACK_BTN_Y_SIZE 62

#define PARA_UI_FILE_BTN_HEIGHT 72
...
#define LINE_MAX_NUMBERS    6
#define BTN_ENABLED_WIDTH   36
#define BTN_ENABLED_HEIGHT  36
#define BTN_ARROW_WIDTH     10
#define BTN_ARROW_HEIGHT    17
#define PARA_UI_MENU_ITEM_Y(n)  (line_points[n]->y - PARA_UI_SIZE_Y/2 - PARA_UI_POS_Y/2)
#define PARA_UI_ENABLED_Y(n)    (line_points[n]->y - BTN_ENABLED_HEIGHT/2 - PARA_UI_POS_Y/2)
  ...
  extern bool has_probe;
  extern bool enabled_thermal_protection;
  extern lv_point_t button_pixel_point[6];
extern lv_style_t tft_style_label_HT;
extern lv_style_t page_label_green_style;
extern lv_style_t style_para_button;

  inline void set_auto_leveling_state(mixware_level_state state) { level_state = state; }
  inline mixware_level_state get_auto_leveling_state() { return level_state; }
  inline void set_heating_mode_temperature(int16_t temp) { gCfgItems.filament_max_temper = temp; }
  inline int16_t get_heating_mode_temperature() { return gCfgItems.filament_max_temper; }
  inline bool get_heating_mode() { return (get_heating_mode_temperature() < 300); }
  inline const char *get_heating_mode_tr() { return (get_heating_mode() ? pidtemp_sw_menu.normal : pidtemp_sw_menu.high); }
  inline const char *get_heating_mode_image_path() { return (get_heating_mode() ? "F:/img_normal_mode.bin" : "F:/HI_high_mode.bin"); }
  inline void set_thermal_protection(bool en) { enabled_thermal_protection = en; }
  inline void toggle_thermal_protection() { enabled_thermal_protection ^= true; }
  inline bool get_thermal_protection() { return enabled_thermal_protection; }
