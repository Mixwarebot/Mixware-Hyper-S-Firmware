...
void machine_setting_disp() {
  if (gCfgItems.language == LANG_SIMPLE_CHINESE) {
    ...
    if (gCfgItems.language == LANG_SIMPLE_CHINESE) {
      ...
      machine_menu.ADVSeteHeatingMode = MTR_ADVSET_THERMALPROTECTION_SCN;
      machine_menu.posTips = PAUSE_POSITION_TIPS_CN;
      set_menu.powerloss_on = MTR_POWER_LOSS_ON_CN;
      set_menu.powerloss_off = MTR_POWER_LOSS_OFF_CN;
      set_menu.thermal_on = MTR_THERMAL_ON_CN;
      set_menu.thermal_off = MTR_THERMAL_OFF_CN;
      machine_menu.update = MTR_UPDATE_CN;
      machine_menu.extrudeMinTemp = MTR_EXTRUDE_MINTEMP_CN;
    }
    else {
      machine_menu.RunoutConfText = RUNOUT_CONF_TEXT_EN;
      machine_menu.ButtonTips = MENU_BUTTON_TIPS_EN;
      machine_menu.ADVSeteHeatingMode = MTR_ADVSET_THERMALPROTECTION_EN;
      machine_menu.posTips = PAUSE_POSITION_TIPS_EN;
      set_menu.powerloss_on = MTR_POWER_LOSS_ON_EN;
      set_menu.powerloss_off = MTR_POWER_LOSS_OFF_EN;
      set_menu.thermal_on = MTR_THERMAL_ON_EN;
      set_menu.thermal_off = MTR_THERMAL_OFF_EN;
      machine_menu.update = MTR_UPDATE_EN;
      machine_menu.extrudeMinTemp = MTR_EXTRUDE_MINTEMP_EN;
    }
  #endif
}
...
void disp_language_init() {
  ...
  switch (gCfgItems.language) {
    ...
    if (gCfgItems.language == LANG_SIMPLE_CHINESE) {
      ...
      operation_menu.babystep_tips                  = MTR_BABYSTEP_TIPS_CN;

      is_freq_menu.is_freq_menu                     = MTR_IS_FREQ_CN;
      is_freq_menu.is_freq_menu_set                 = MTR_IS_FREQ_SET_CN;
      is_freq_menu.is_freq_menu_tips                = MTR_IS_FREQ_TIPS_CN;
      is_freq_menu.is_freq_menu_x                   = MTR_IS_FREQ_X_CN;
      is_freq_menu.is_freq_menu_y                   = MTR_IS_FREQ_Y_CN;
    }
    else {
      ...
      operation_menu.babystep_tips                  = MTR_BABYSTEP_TIPS_EN;
      ...
      is_freq_menu.is_freq_menu                     = MTR_IS_FREQ_EN;
      is_freq_menu.is_freq_menu_set                 = MTR_IS_FREQ_SET_EN;
      is_freq_menu.is_freq_menu_tips                = MTR_IS_FREQ_TIPS_EN;
      is_freq_menu.is_freq_menu_x                   = MTR_IS_FREQ_X_EN;
      is_freq_menu.is_freq_menu_y                   = MTR_IS_FREQ_Y_EN;
    }
  #endif
}
