...
static FSTR_P const assets[] = {
  ...
  F("img_extruct.bin"),
    ...
    F("img_bed.bin"),
  #endif
  F("img_step_degree_1.bin"),
  F("img_step_degree_5.bin"),
  F("img_step_degree_10.bin"),
  F("img_add.bin"),
  F("img_dec.bin"),
  F("img_preheat_PLA.bin"),
  F("img_preheat_PETG.bin"),
  F("img_preheat_PACF.bin"),
  F("img_preheat_Bed.bin"),
  F("img_preheat_Cool.bin"),

  //filamentchange screen
  F("img_filamentchange_in.bin"),
  F("img_filamentchange_out.bin"),
  F("img_powerloss.bin"),
  F("img_thermalpro.bin"),
  ...
  F("img_level_4.bin"),
  F("img_level_5.bin"),
  F("img_motor_off_all.bin"),
  F("img_level_z_offset.bin"),
  F("img_level_auto.bin"),
  F("img_level_manual.bin"),
  F("img_save.bin"),

  //move motor screen
  //TODO: 6 equal icons, just in diffenct rotation... it may be optimized too
  F("img_xpos_state.bin"),
  F("img_ypos_state.bin"),
  F("img_zpos_state.bin"),
  F("img_step_mm_0_1.bin"),
  F("img_step_mm_1.bin"),
  F("img_step_mm_5.bin"),
  F("img_step_mm_10.bin"),
  F("img_axis_x.bin"),
  F("img_axis_y.bin"),
  F("img_axis_z.bin"),
  ...
  F("img_eeprom.bin"),
  F("img_about.bin"),
  F("img_machine_para.bin"),
  F("img_debug_z.bin"),
  F("img_axis_z_test_s.bin"),
  F("img_axis_z_test_f.bin"),
  F("img_self_check.bin"),

  //lang select screen
  #if HAS_LANG_SELECT_SCREEN
    F("img_language.bin"),
    F("img_language_En.bin"),
    F("img_language_En_sel.bin"),
    F("img_language_zh_CN.bin"),
    F("img_language_zh_CN_sel.bin"),
  #endif // HAS_LANG_SELECT_SCREEN

  //fan screen
  F("img_speed_slow.bin"),
  F("img_speed_high.bin"),
  ...
  //extrusion screen
  F("img_speed_normal.bin"),

  //operation screen
  F("img_run_out.bin"),
  F("img_run_out_on.bin"),
  F("img_run_out_off.bin"),

  //change speed screen
  F("img_step_percent_1.bin"),
  F("img_step_percent_5.bin"),
  F("img_step_percent_10.bin"),
  ...
  F("img_opreate_dis.bin"),
  F("img_babystep_dis.bin")
