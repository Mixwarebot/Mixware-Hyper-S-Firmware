...
#define LEVELING_ZOFFSET_TITLE_EN       "Z Offset Wizard"
...
#define ACCELERATION_CONF_TITLE_EN      "Acceleration Settings"
...
#define JERK_CONF_TITLE_EN              "Jerk Speed Settings"
...
#define E0_TMC_MODE_EN                  "Whether E-axis Enables StealthChop Mode"
#define E1_TMC_MODE_EN                  "Whether E-axis Enables StealthChop Mode"
...
#define ADVANCED_CONF_TITLE_EN          "Configuration"
...
#define LEVELING_POINT1_TEXT_EN       "Front Left"
#define LEVELING_POINT2_TEXT_EN       "Front Right"
#define LEVELING_POINT3_TEXT_EN       "Center"
#define LEVELING_POINT4_TEXT_EN       "Back Left"
#define LEVELING_POINT5_TEXT_EN       "Back Right"
...
#define TITLE_READYPRINT_EN                 "Main"
...
#define MORE_CUSTOM6_TEXT_EN  MAIN_MENU_ITEM_6_DESC
  ...
  #define PIDTEMP_SW_NMODEL_EN                  "Normal Mode"
  #define PIDTEMP_SW_HMODEL_EN                  "High Mode"
  ...
  #define MTR_BABYSTEP_TIPS_EN                "(Tips: Babystep will be delayed.)"

  #define MTR_POWER_LOSS_ON_EN                  "Power Loss\nRecovery:On"
  #define MTR_POWER_LOSS_OFF_EN                 "Power Loss\nRecovery:Off"
  #define MTR_THERMAL_ON_EN                     "  Thermal\nProtection:On"
  #define MTR_THERMAL_OFF_EN                    "  Thermal\nProtection:Off"
  #define MTR_UPDATE_EN                         "Update"

  #define MTR_IS_FREQ_EN                        "Input Shaping Settings"
  #define MTR_IS_FREQ_SET_EN                    "Input Shaping Settings"
  #define MTR_IS_FREQ_TIPS_EN                   "(Frequency Range of 15Hz to 60Hz.)"
  #define MTR_IS_FREQ_X_EN                      "X-Axis Frequency (Hz)"
  #define MTR_IS_FREQ_Y_EN                      "Y-Axis Frequency (Hz)"
  #define MTR_EXTRUDE_MINTEMP_EN                "Minimum Extrusion Temp."
#endif
