...
void lv_draw_acceleration_settings() {
    ...
    itoa(planner.settings.acceleration, public_buf_l, 10);
    lv_screen_menu_item_1_edit(scr, machine_menu.PrintAcceleration, PARA_UI_POS_X, PARA_UI_MENU_ITEM_Y(0), event_handler, ID_ACCE_PRINT, 0, public_buf_l);

    itoa(planner.settings.retract_acceleration, public_buf_l, 10);
    lv_screen_menu_item_1_edit(scr, machine_menu.RetractAcceleration, PARA_UI_POS_X, PARA_UI_MENU_ITEM_Y(1), event_handler, ID_ACCE_RETRA, 1, public_buf_l);

    itoa(planner.settings.travel_acceleration, public_buf_l, 10);
    lv_screen_menu_item_1_edit(scr, machine_menu.TravelAcceleration, PARA_UI_POS_X, PARA_UI_MENU_ITEM_Y(2), event_handler, ID_ACCE_TRAVEL, 2, public_buf_l);
