...
void lv_draw_eeprom_settings() {
  scr = lv_screen_create(EEPROM_SETTINGS_UI, eeprom_menu.title);
  lv_screen_menu_item(scr, eeprom_menu.revert, PARA_UI_POS_X, PARA_UI_MENU_ITEM_Y(0), event_handler, ID_EEPROM_REVERT, 0);
  lv_screen_menu_item(scr, eeprom_menu.store, PARA_UI_POS_X, PARA_UI_MENU_ITEM_Y(1), event_handler, ID_EEPROM_STORE, 1);
