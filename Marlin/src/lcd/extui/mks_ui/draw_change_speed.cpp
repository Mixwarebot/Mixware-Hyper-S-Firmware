...
void disp_speed_step() {
  if (uiCfg.stepPrintSpeed == 1)
    lv_imgbtn_set_src_both(buttonStep, TERN(TFT_MIXWARE_UI, "F:/img_step_percent_1.bin",  "F:/bmp_step1_percent.bin"));
  else if (uiCfg.stepPrintSpeed == 5)
    lv_imgbtn_set_src_both(buttonStep, TERN(TFT_MIXWARE_UI, "F:/img_step_percent_5.bin",  "F:/bmp_step5_percent.bin"));
  else if (uiCfg.stepPrintSpeed == 10)
    lv_imgbtn_set_src_both(buttonStep, TERN(TFT_MIXWARE_UI, "F:/img_step_percent_10.bin", "F:/bmp_step10_percent.bin"));
...
void disp_speed_type() {
  #if ENABLED(TFT_MIXWARE_UI)
    lv_imgbtn_set_src_both(buttonType, editingFlowrate ? get_heating_mode() ? "F:/img_extruct.bin" : "F:/HI_extruct.bin" : "F:/img_move.bin");
