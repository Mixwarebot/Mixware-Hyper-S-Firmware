...
void lv_draw_about() {
    ...
    fw_type = lv_label_create(scr, "Firmware: Mixware Hyper S " TFT_MIXWARE_UI_VERSION );
    ...
    lv_obj_t *fw_type_3 = lv_label_create(scr, "Web: www.mixwarebot.com");
    lv_obj_align(fw_type_3, nullptr, LV_ALIGN_CENTER, 0, 36);
  #else
