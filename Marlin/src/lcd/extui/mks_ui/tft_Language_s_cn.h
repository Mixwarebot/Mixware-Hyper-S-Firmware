...
#define MACHINE_CONFIG_TITLE_CN       "机器参数>机器设置"
...
#define E0_MAXFEEDRATE_CN             "E轴最大速度"
#define E1_MAXFEEDRATE_CN             "E轴最大速度"

#define ACCELERATION_CONF_TITLE_CN    "机器参数>加速度设置"
...
#define E0_ACCELERATION_CN            "E轴加速度"
#define E1_ACCELERATION_CN            "E轴加速度"

#define JERK_CONF_TITLE_CN            "机器参数>突变速度设置"
...
#define E0_STEPS_CN                   "E轴脉冲"
#define E1_STEPS_CN                   "E轴脉冲"

#define TMC_CURRENT_CONF_TITLE_CN     "机器参数>TMC驱动电流设置"
#define X_TMC_CURRENT_CN              "X轴电流(毫安)"
#define Y_TMC_CURRENT_CN              "Y轴电流(毫安)"
#define Z_TMC_CURRENT_CN              "Z轴电流(毫安)"
#define E0_TMC_CURRENT_CN             "E轴电流(毫安)"
#define E1_TMC_CURRENT_CN             "E轴电流(毫安)"
...
#define E0_TMC_MODE_CN                "E轴是否使能静音模式"
#define E1_TMC_MODE_CN                "E轴是否使能静音模式"

#define MOTORDIR_CONF_TITLE_CN        "机器参数>电机方向"
#define X_MOTORDIR_CN                 "X轴电机方向"
#define Y_MOTORDIR_CN                 "Y轴电机方向"
#define Z_MOTORDIR_CN                 "Z轴电机方向"
#define E0_MOTORDIR_CN                "E轴电机方向"
#define E1_MOTORDIR_CN                "E轴电机方向"
...
#define ADVANCED_CONF_TITLE_CN        "机器参数"
...
#define LEVELING_POINT1_TEXT_CN   "左前方"
#define LEVELING_POINT2_TEXT_CN   "右前方"
#define LEVELING_POINT3_TEXT_CN   "中心点"
#define LEVELING_POINT4_TEXT_CN   "左后方"
#define LEVELING_POINT5_TEXT_CN   "右后方"
...
#define EEPROM_SETTINGS_CN        "出厂设置"
...
#define DIALOG_ERROR_TIPS1_CN       "错误:找不到文件,请插入u盘!"
...
#define DIALOG_PAUSING_TIPS_CN      "暂停中..."
...
#define MORE_CUSTOM6_TEXT_CN  MAIN_MENU_ITEM_6_DESC
  ...
  #undef OFFSET_Y_CN
  #undef OFFSET_Z_CN
  #undef EXTRUDER_1_TEXT_CN
  #undef EXTRUDER_2_TEXT_CN
  #undef FILAMENT_EXT0_TEXT_CN
  #undef FILAMENT_EXT1_TEXT_CN
  #undef EEPROM_SETTINGS_STORE_CN
  #undef EEPROM_STORE_TIPS_CN
  #undef PAUSE_POSITION_X_CN
  #undef PAUSE_POSITION_Y_CN
  #undef PAUSE_POSITION_Z_CN
  #undef TITLE_LEVELING_CN

  #define OFFSET_X_CN                           "X轴偏移补偿"
  #define OFFSET_Y_CN                           "Y轴偏移补偿"
  #define OFFSET_Z_CN                           "Z轴偏移补偿"
  #define ADJUST_Z_MENU_SAVE_CN                 "保存"
  #define ADJUST_Z_MENU_ADD_CN                  "抬升喷嘴"
  #define ADJUST_Z_MENU_DEC_CN                  "下降喷嘴"
  #define MENU_WAIT_START_CN                    "正在启动, 请稍等"
  #define RUNOUT_CONF_TEXT_CN                   "启动材料检测"
  #define EXTRUDER_1_TEXT_CN                    "喷嘴"
  #define EXTRUDER_2_TEXT_CN                    "喷嘴"
  #define FILAMENT_EXT0_TEXT_CN                 "喷嘴"
  #define FILAMENT_EXT1_TEXT_CN                 "喷嘴"
  #define FILAMENT_DIALOG_LOAD_SELECT_TIPS_CN   "准备进料,请选择需要装载的耗材!"
  #define FILAMENT_DIALOG_UNLOAD_SELECT_TIPS_CN "准备退料,请选择需要卸载的耗材!"
  #define FILAMENT_DIALOG_CLOGGING_CN           "检测到耗材堵塞, 暂停打印\n请清理喷嘴, 按<确定>返回"
  #define FILAMENT_SENSOR_ON_CN                 "材料检测: 开"
  #define FILAMENT_SENSOR_OFF_CN                "材料检测: 关"
  #define FILAMENT_DIALOG_BREAKING_CN           "耗材状态异常, 暂停打印中...."
  #define FILAMENT_DIALOG_BREAK_TITLE_CN        "材料检测: 耗材状态异常"
  #define TEXT_BABY_STEP_CN                     "微移动"
  #define AUTO_LEVELING_TITLE_CN                "自动调平"
  #define AUTO_LEVELING_COMPLETED_CN            "按<确定>开始自动调平"
  #define AUTO_LEVELING_LEVELING_CN             "正在进行调平,请等待调平完成"
  #define AUTO_LEVELING_FINISHED_CN             "  自动调平完成,按<确定>返回,\n按<调整>开始调整Z轴补偿高度"
  #define AUTO_LEVELING_FAILED_CN               "自动调平失败,按<确定>返回"
  #define EEPROM_SETTINGS_STORE_CN              "保存参数至打印机"
  #define EEPROM_STORE_TIPS_CN                  "是否保存参数到打印机?"
  #define PAUSE_POSITION_X_CN                   "X轴暂停位置(绝对位置)"
  #define PAUSE_POSITION_Y_CN                   "Y轴暂停位置(绝对位置)"
  ...
  #define PIDTEMP_SW_TITLE_CN                   "加热模式设置"
  #define PIDTEMP_SW_NMODEL_CN                  "普通模式"
  #define PIDTEMP_SW_HMODEL_CN                  "高温模式"
  #define PIDTEMP_SW_NMODEL_CUR_CN              "当前加热模式: 普通模式"
  #define PIDTEMP_SW_HMODEL_CUR_CN              "当前加热模式: 高温模式"
  #define PIDTEMP_SW_NMODEL_TIP_CN              "   点击<确定>更改为普通模式.\n(此模式需配置普通喷头组件使用)"
  #define PIDTEMP_SW_HMODEL_TIP_CN              "   点击<确定>更改为高温模式.\n(此模式需配置高温喷头组件使用)"
  #define HIGH_HEAT_MODE_CN                     "高温模式"
  #define HIGH_HEAT_MODE_TIPS_CN                "高温模式"
  #define FILAMENT_ADJUST_TEMP_CN               "调整温度"
  #define DIALOG_PRINT_AGAIN_CN                 "再次打印"

  #define DEBUG_SELF_CHECK_TITLE_CN             "自检模式"
  #define DEBUG_SELF_CHECK_CONFIRM_CN           "检 测"
  #define DEBUG_SELF_CHECK_CHECKING_CN          "正在检测, 请稍等."
  #define DEBUG_SELF_CHECK_AXIS_SLOW_CN         "低速测试"
  #define DEBUG_SELF_CHECK_AXIS_FAST_CN         "高速测试"
  #define DEBUG_SELF_CHECK_TIPS_E_TEMP_CN       "喷头温度"
  #define DEBUG_SELF_CHECK_TIPS_B_TEMP_CN       "热床温度"
  #define DEBUG_SELF_CHECK_TIPS_E_HEAT_CN       "喷头加热"
  ...
  #define DEBUG_SELF_CHECK_TIPS_E_MOTOR_CN      "E轴电机"
  ...
  #define MTR_BABYSTEP_TIPS_CN                 "(提示: 微移动存在延迟.)"

  #define MTR_POWER_LOSS_ON_CN                  "断电续打: 开"
  #define MTR_POWER_LOSS_OFF_CN                 "断电续打: 关"
  #define MTR_THERMAL_ON_CN                     "热保护: 开"
  #define MTR_THERMAL_OFF_CN                    "热保护: 关"
  #define MTR_UPDATE_CN                         "更新"

  #define MTR_IS_FREQ_CN                        "机器参数>输入整形设置"
  #define MTR_IS_FREQ_SET_CN                    "输入整型设置"
  #define MTR_IS_FREQ_TIPS_CN                   "(频率范围为 15Hz 至 60Hz)"
  #define MTR_IS_FREQ_X_CN                      "X轴共振频率(Hz)"
  #define MTR_IS_FREQ_Y_CN                      "Y轴共振频率(Hz)"
  #define MTR_EXTRUDE_MINTEMP_CN                "最低挤出温度"
#endif
