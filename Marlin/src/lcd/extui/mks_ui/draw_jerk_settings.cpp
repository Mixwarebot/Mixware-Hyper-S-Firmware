...
void lv_draw_jerk_settings() {
  ...
  lv_screen_menu_item_1_edit(scr, machine_menu.X_Jerk, PARA_UI_POS_X, PARA_UI_MENU_ITEM_Y(0), event_handler, ID_JERK_X, 0, public_buf_l);

  dtostrf(planner.max_jerk.y, 1, 1, public_buf_l);
  lv_screen_menu_item_1_edit(scr, machine_menu.Y_Jerk, PARA_UI_POS_X, PARA_UI_MENU_ITEM_Y(1), event_handler, ID_JERK_Y, 1, public_buf_l);

  dtostrf(planner.max_jerk.z, 1, 1, public_buf_l);
  lv_screen_menu_item_1_edit(scr, machine_menu.Z_Jerk, PARA_UI_POS_X, PARA_UI_MENU_ITEM_Y(2), event_handler, ID_JERK_Z, 2, public_buf_l);

  dtostrf(planner.max_jerk.e, 1, 1, public_buf_l);
  lv_screen_menu_item_1_edit(scr, machine_menu.E_Jerk, PARA_UI_POS_X, PARA_UI_MENU_ITEM_Y(3), event_handler, ID_JERK_E, 3, public_buf_l);
