...
void machine_setting_disp() {
  if (gCfgItems.language == LANG_SIMPLE_CHINESE) {
    ...
    machine_menu.posTips        = PAUSE_POSITION_TIPS_CN;
    ...
    machine_menu.posTips        = PAUSE_POSITION_TIPS_T_CN;
    ...
    machine_menu.posTips        = PAUSE_POSITION_TIPS_EN;
...
void disp_language_init() {
  ...
  switch (gCfgItems.language) {
    ...
    filament_menu.filament_clogging_title           = FILAMENT_DIALOG_BREAK_TITLE_EN;
    ...
    switch (gCfgItems.language) {
      case LANG_SIMPLE_CHINESE:
        ...
        adjust_z_menu.save                          = ADJUST_Z_MENU_SAVE_CN;
        adjust_z_menu.add                           = ADJUST_Z_MENU_ADD_CN;
        adjust_z_menu.dec                           = ADJUST_Z_MENU_DEC_CN;
        adjust_z_menu.wait_start                    = MENU_WAIT_START_CN;
        autolevel_menu.title                        = AUTO_LEVELING_TITLE_CN;
        autolevel_menu.completed                    = AUTO_LEVELING_COMPLETED_CN;
        autolevel_menu.leveling                     = AUTO_LEVELING_LEVELING_CN;
      ...
      case LANG_COMPLEX_CHINESE:
        ...
        adjust_z_menu.save                          = ADJUST_Z_MENU_SAVE_T_CN;
        adjust_z_menu.add                           = ADJUST_Z_MENU_ADD_T_CN;
        adjust_z_menu.dec                           = ADJUST_Z_MENU_DEC_T_CN;
        adjust_z_menu.wait_start                    = MENU_WAIT_START_T_CN;
        autolevel_menu.title                        = AUTO_LEVELING_TITLE_T_CN;
        autolevel_menu.completed                    = AUTO_LEVELING_COMPLETED_T_CN;
        autolevel_menu.leveling                     = AUTO_LEVELING_LEVELING_T_CN;
      ...
      case LANG_RUSSIAN:
        ...
        adjust_z_menu.save                          = ADJUST_Z_MENU_SAVE_RU;
        adjust_z_menu.add                           = ADJUST_Z_MENU_ADD_RU;
        adjust_z_menu.dec                           = ADJUST_Z_MENU_DEC_RU;
        adjust_z_menu.wait_start                    = MENU_WAIT_START_RU;
        autolevel_menu.title                        = AUTO_LEVELING_TITLE_RU;
        autolevel_menu.completed                    = AUTO_LEVELING_COMPLETED_RU;
        autolevel_menu.leveling                     = AUTO_LEVELING_LEVELING_RU;
      ...
      case LANG_SPANISH:
        ...
        adjust_z_menu.save                          = ADJUST_Z_MENU_SAVE_SP;
        adjust_z_menu.add                           = ADJUST_Z_MENU_ADD_SP;
        adjust_z_menu.dec                           = ADJUST_Z_MENU_DEC_SP;
        adjust_z_menu.wait_start                    = MENU_WAIT_START_SP;
        autolevel_menu.title                        = AUTO_LEVELING_TITLE_SP;
        autolevel_menu.completed                    = AUTO_LEVELING_COMPLETED_SP;
        autolevel_menu.leveling                     = AUTO_LEVELING_LEVELING_SP;
      ...
      case LANG_FRENCH:
        ...
        adjust_z_menu.save                          = ADJUST_Z_MENU_SAVE_FR;
        adjust_z_menu.add                           = ADJUST_Z_MENU_ADD_FR;
        adjust_z_menu.dec                           = ADJUST_Z_MENU_DEC_FR;
        adjust_z_menu.wait_start                    = MENU_WAIT_START_FR;
        autolevel_menu.title                        = AUTO_LEVELING_TITLE_FR;
        autolevel_menu.completed                    = AUTO_LEVELING_COMPLETED_FR;
        autolevel_menu.leveling                     = AUTO_LEVELING_LEVELING_FR;
      ...
      case LANG_ITALY:
        ...
        adjust_z_menu.save                          = ADJUST_Z_MENU_SAVE_IT;
        adjust_z_menu.add                           = ADJUST_Z_MENU_ADD_IT;
        adjust_z_menu.dec                           = ADJUST_Z_MENU_DEC_IT;
        adjust_z_menu.wait_start                    = MENU_WAIT_START_IT;
        autolevel_menu.title                        = AUTO_LEVELING_TITLE_IT;
        autolevel_menu.completed                    = AUTO_LEVELING_COMPLETED_IT;
        autolevel_menu.leveling                     = AUTO_LEVELING_LEVELING_IT;
