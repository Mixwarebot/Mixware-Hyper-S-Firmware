...
#define EEPROM_SETTINGS_TITLE_RU      "Заводские настройки"
#define EEPROM_SETTINGS_STORE_RU      "Cохранение настроек в EEPROM"
#define EEPROM_SETTINGS_READ_RU       "Чтение настроек из EEPROM"
#define EEPROM_SETTINGS_REVERT_RU     "Восстановить заводские настройки"
...
#define EEPROM_REVERT_TIPS_RU         "Восстановить заводские настройки?"
#define EEPROM_SETTINGS_RU            "Заводские настройки"
...
#define LEVELING_CONF_TITLE_RU          "Hастройки уровня"
...
#define MACHINE_CONFIG_TITLE_RU         "настройки притера"
...
#define MOTOR_CONF_TITLE_RU             "Hастройки моторов"
...
#define ACCELERATION_CONF_TITLE_RU      "ускорения"
...
#define MAXFEEDRATE_CONF_TITLE_RU       "максимальная скорость"
#define X_MAXFEEDRATE_RU                "максимальная скорость X"
#define Y_MAXFEEDRATE_RU                "максимальная скорость Y"
#define Z_MAXFEEDRATE_RU                "максимальная скорость Z"
#define E0_MAXFEEDRATE_RU               "максимальная скорость E"
#define E1_MAXFEEDRATE_RU               "максимальная скорость E"

#define JERK_CONF_TITLE_RU              "скорость рывка"
...
#define STEPS_CONF_TITLE_RU             "настройки шагов"
...
#define TMC_CURRENT_CONF_TITLE_RU       "TMC настройка токов"
...
#define TMC_MODE_CONF_TITLE_RU          "TMC настройки режима шагов"
...
#define ADVANCED_CONF_TITLE_RU          "Pасширенные"
#define PAUSE_POSITION_RU    "Hастройки позиции паузы печати"
#define PAUSE_POSITION_X_RU  "положение по X"
#define PAUSE_POSITION_Y_RU  "положение по Y"
#define PAUSE_POSITION_Z_RU  "положение по Z"

#define OFFSET_TITLE_RU  "отступ"
#define OFFSET_X_RU      "X отступ"
#define OFFSET_Y_RU      "Y отступ"
#define OFFSET_Z_RU      "Z отступ"

#define FILAMENT_CONF_TITLE_RU          "Hастройки филамента"
...
#define ENCODER_CONF_TITLE_RU           "Hастройки энкодера"
#define ENCODER_CONF_TEXT_RU            "энкодер используется?"

//end of Malderin translate

#if ENABLED(MIXWARE_MODEL_V)
  #undef EXTRUDER_1_TEXT_RU
  #undef EXTRUDER_2_TEXT_RU
  #undef FILAMENT_EXT0_TEXT_RU
  ...
  #define ADJUST_Z_MENU_ADD_RU                  "Сопло вверх"
  #define ADJUST_Z_MENU_DEC_RU                  "Нижнее сопло"
  #define MENU_WAIT_START_RU                    "Запуск, пожалуйста подождите...."
  #define RUNOUT_CONF_TEXT_RU                   "Детектор нити"
  #define EXTRUDER_1_TEXT_RU                    "экструдер"
  #define EXTRUDER_2_TEXT_RU                    "экструдер"
  #define FILAMENT_EXT0_TEXT_RU                 "экструдер"
  #define FILAMENT_EXT1_TEXT_RU                 "экструдер"
  #define FILAMENT_DIALOG_LOAD_SELECT_TIPS_RU   "Пожалуйста, выберите нить для загрузки."
  #define FILAMENT_DIALOG_UNLOAD_SELECT_TIPS_RU "Пожалуйста, выберите нить для выгрузки."
  #define FILAMENT_DIALOG_CLOGGING_RU           "The filament is clogging,\nplease clear the nozzle.\nclick <confirm> for return!"
  #define FILAMENT_SENSOR_ON_RU                 "Filament\nDetector: On"
  #define FILAMENT_SENSOR_OFF_RU                "Filament\nDetector: Off"
  #define AUTO_LEVELING_TITLE_RU                "Auto Leveling"
  #define AUTO_LEVELING_COMPLETED_RU            "Click <confirm> for start auto leveling"
  #define AUTO_LEVELING_LEVELING_RU             "In Auto leveling, please wait!"
  #define AUTO_LEVELING_FINISHED_RU             "Auto leveling completed.\nclick <confirm> for return!\nclick <adjust> for Z offset!"
