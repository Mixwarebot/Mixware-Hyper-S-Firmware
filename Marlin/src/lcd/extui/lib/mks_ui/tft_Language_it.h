...
#define EEPROM_SETTINGS_IT            "Impostazione di fabbrica"
...
#define EEPROM_SETTINGS_TITLE_IT          "Impostazione di fabbrica"
...
#define EEPROM_SETTINGS_REVERT_IT         "Ripristinare le impostazioni predefinite"
...
#define MORE_CUSTOM7_TEXT_IT  USER_DESC_7
  ...
  #undef EXTRUDER_1_TEXT_IT
  #undef EXTRUDER_2_TEXT_IT
  #undef FILAMENT_EXT0_TEXT_IT
  ...
  #define ADJUST_Z_MENU_ADD_IT                  "Su Ugello"
  #define ADJUST_Z_MENU_DEC_IT                  "Giù Ugello"
  #define MENU_WAIT_START_IT                    "Avvio, per favore aspetta...."
  #define RUNOUT_CONF_TEXT_IT                   "Filamento Rivelatore"
  #define EXTRUDER_1_TEXT_IT                    "Estrude"
  #define EXTRUDER_2_TEXT_IT                    "Estrude"
  #define FILAMENT_EXT0_TEXT_IT                 "Estrude"
  #define FILAMENT_EXT1_TEXT_IT                 "Estrude"
  #define FILAMENT_DIALOG_LOAD_SELECT_TIPS_IT   "Selezionare il filamento da caricare."
  #define FILAMENT_DIALOG_UNLOAD_SELECT_TIPS_IT "Selezionare il filamento da scaricare."
  #define FILAMENT_DIALOG_CLOGGING_IT           "Il filamento sta intasando,\nPulire il pulsante.\nfare clic su <conferma> per il ritorno!"
  #define FILAMENT_SENSOR_ON_IT                 "Filamento\nRivelatore: On"
  #define FILAMENT_SENSOR_OFF_IT                "Filamento\nRivelatore: Off"
  #define AUTO_LEVELING_TITLE_IT                "Livellamento automatico"
  #define AUTO_LEVELING_COMPLETED_IT            "fare clic su <conferma> per avvia livellamento automatico"
  #define AUTO_LEVELING_LEVELING_IT             "In livellamento automatico, attendere!"
  #define AUTO_LEVELING_FINISHED_IT             "Livellamento automatico completato. \nfare clic su <conferma> per il ritorno!\nFai clic su <regola> per Z offset!"
  #define AUTO_LEVELING_FAILED_IT               "Livellamento automatico non riuscito, fai clic su <conferma> per il ritorno!"
  #define EEPROM_SETTINGS_STORE_IT              "Salva le impostazioni sulla stampante"
  #define EEPROM_STORE_TIPS_IT                  "Salva le impostazioni sulla stampante?"
