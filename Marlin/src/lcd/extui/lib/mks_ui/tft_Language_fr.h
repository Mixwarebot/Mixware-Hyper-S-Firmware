...
#define EXTRUDER_1_TEXT_FR            "Extr"
#define EXTRUDER_2_TEXT_FR            "Extr"
...
#define EEPROM_SETTINGS_FR            "Réglage d'usine"
...
#define FILAMENT_EXT0_TEXT_FR         "Extr"
#define FILAMENT_EXT1_TEXT_FR         "Extr"
...
#define EXTRUDER_E_LENGTH1_TEXT_FR    "Extruder"
#define EXTRUDER_E_LENGTH2_TEXT_FR    "Extruder"
#define EXTRUDER_E_LENGTH3_TEXT_FR    "Extruder"
...
#define TITLE_CHANGESPEED_FR          "La vitesse"
...
#define EEPROM_SETTINGS_TITLE_FR  "Réglage d'usine"
...
#define EEPROM_REVERT_TIPS_FR "Rétablir les paramètres d'usine?"
...
#define MORE_CUSTOM7_TEXT_FR  USER_DESC_7
  ...
  #undef EXTRUDER_1_TEXT_FR
  #undef EXTRUDER_2_TEXT_FR
  #undef FILAMENT_EXT0_TEXT_FR
  ...
  #define ADJUST_Z_MENU_ADD_FR                  "La buses"
  #define ADJUST_Z_MENU_DEC_FR                  "La baisse buses"
  #define MENU_WAIT_START_FR                    "En cours de lancement,\nVeuillez attendre..."
  #define RUNOUT_CONF_TEXT_FR                   "Détection des filaments"
  #define EXTRUDER_1_TEXT_FR                    "Extr"
  #define EXTRUDER_2_TEXT_FR                    "Extr"
  #define FILAMENT_EXT0_TEXT_FR                 "Extr"
  #define FILAMENT_EXT1_TEXT_FR                 "Extr"
  #define FILAMENT_DIALOG_LOAD_SELECT_TIPS_FR   "Veuillez sÃ©lectionner le filament Ã  charger."
  #define FILAMENT_DIALOG_UNLOAD_SELECT_TIPS_FR "Veuillez sÃ©lectionner le filament Ã  dÃ©charger."
  #define FILAMENT_DIALOG_CLOGGING_FR           "Le filament est obstrué,\nS’il vous plaît, dégagez la buse.\ncliquez sur <confirmer> pour retour!"
  #define FILAMENT_SENSOR_ON_FR                 "Fil laminé\ndétecteur: On"
  #define FILAMENT_SENSOR_OFF_FR                "Fil laminé\ndétecteur: Off"
  #define AUTO_LEVELING_TITLE_FR                "Nivellement automatique"
  #define AUTO_LEVELING_COMPLETED_FR            "Cliquez sur <confirmer> pour commencez le nivellement automatique"
  #define AUTO_LEVELING_LEVELING_FR             "Nivellement automatique, veuillez patienter!"
  #define AUTO_LEVELING_FINISHED_FR             "Niveau automatique terminÃ©.\ncliquez sur <confirmer> pour retour!\nCliquez sur <ajuster> pour Z offset!"
  #define AUTO_LEVELING_FAILED_FR               "Ã‰chec du nivellement automatique, cliquez sur < confirmer > pour retour!"
  #define EEPROM_SETTINGS_STORE_FR              "Enregistrer les paramètres sur l'imprimante"
  #define EEPROM_STORE_TIPS_FR                  "Enregistrer les paramètres sur l'imprimante?"
  #define TITLE_LEVELING_FR                     "Manual leveling"
#endif
