...
#else
  #define DEFAULT_VIEW_WIDTH              (160)
  #define DEFAULT_VIEW_MAX_SIZE           (DEFAULT_VIEW_WIDTH*200*2)
  #define FLASH_VIEW_MAX_SIZE             (DEFAULT_VIEW_WIDTH*200*2)
#endif
...
#define FLASH_INF_VALID_FLAG            0x20220906
