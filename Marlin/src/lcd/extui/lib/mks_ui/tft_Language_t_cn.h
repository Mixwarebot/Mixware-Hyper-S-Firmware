...
#define E0_MAXFEEDRATE_T_CN             "E軸最大速度"
#define E1_MAXFEEDRATE_T_CN             "E軸最大速度"
...
#define E0_ACCELERATION_T_CN            "E軸加速度"
#define E1_ACCELERATION_T_CN            "E軸加速度"
...
#define E0_STEPS_T_CN                   "E軸脈沖"
#define E1_STEPS_T_CN                   "E軸脈沖"
...
#define E0_TMC_CURRENT_T_CN             "E軸電流(毫安)"
#define E1_TMC_CURRENT_T_CN             "E軸電流(毫安)"
...
#define E0_TMC_MODE_T_CN                "E軸是否使能靜音模式"
#define E1_TMC_MODE_T_CN                "E軸是否使能靜音模式"
...
#define E0_MOTORDIR_T_CN                "E軸電機方向"
#define E1_MOTORDIR_T_CN                "E軸電機方向"
...
#define EEPROM_SETTINGS_T_CN            "出廠設置"
...
#define FILAMENT_DIALOG_LOAD_CONFIRM1_TIPS_T_CN   "加熱完成,請裝載耗材后,\n  按<確定>開始進料"
...
#define DIALOG_ERROR_TIPS1_T_CN       "錯誤:找不到文件,請插入u盤!"
...
#define MORE_CUSTOM7_TEXT_T_CN  USER_DESC_7
  ...
  #undef OFFSET_Y_T_CN
  #undef OFFSET_Z_T_CN
  #undef EXTRUDER_1_TEXT_T_CN
  #undef EXTRUDER_2_TEXT_T_CN
  #undef FILAMENT_EXT0_TEXT_T_CN
  #undef FILAMENT_EXT1_TEXT_T_CN
  #undef EEPROM_SETTINGS_STORE_T_CN
  #undef EEPROM_STORE_TIPS_T_CN
  ...
  #define OFFSET_Z_T_CN                           "Z軸偏移補償"
  #define ADJUST_Z_MENU_SAVE_T_CN                 "保存"
  #define ADJUST_Z_MENU_ADD_T_CN                  "抬升噴嘴"
  #define ADJUST_Z_MENU_DEC_T_CN                  "下降噴嘴"
  #define MENU_WAIT_START_T_CN                    "正在啟動, 請稍等"
  #define RUNOUT_CONF_TEXT_T_CN                   "啟動材料檢測"
  #define EXTRUDER_1_TEXT_T_CN                    "噴頭"
  #define EXTRUDER_2_TEXT_T_CN                    "噴頭"
  #define FILAMENT_EXT0_TEXT_T_CN                 "噴頭"
  #define FILAMENT_EXT1_TEXT_T_CN                 "噴頭"
  #define FILAMENT_DIALOG_LOAD_SELECT_TIPS_T_CN   "準備進料,請選擇需要裝載的耗材!"
  #define FILAMENT_DIALOG_UNLOAD_SELECT_TIPS_T_CN "準備退料,請選擇需要卸載的耗材!"
  #define FILAMENT_DIALOG_CLOGGING_T_CN           "檢測到耗材堵塞, 暫停打印\n請清理噴頭, 按<確定>返回"
  #define FILAMENT_SENSOR_ON_T_CN                 "材料檢測: 開"
  #define FILAMENT_SENSOR_OFF_T_CN                "材料檢測: 關"
  #define FILAMENT_DIALOG_BREAKING_T_CN           "耗材狀態異常, 暫停打印中...."
  #define FILAMENT_DIALOG_BREAK_TITLE_T_CN        "材料檢測: 耗材狀態異常"
  #define TEXT_BABY_STEP_T_CN                     "微移動"
  #define AUTO_LEVELING_TITLE_T_CN                "自動調平"
  #define AUTO_LEVELING_COMPLETED_T_CN            "按<確定>開始自動調平"
  #define AUTO_LEVELING_LEVELING_T_CN             "正在進行調平,請等待調平完成"
  #define AUTO_LEVELING_FINISHED_T_CN             "  自動調平完成,按<確定>返回,\n按<調整>開始調整Z軸補償高度"
  #define AUTO_LEVELING_FAILED_T_CN               "自動調平失敗,按<確定>返回"
  #define EEPROM_SETTINGS_STORE_T_CN              "保存參數至打印機"
  #define EEPROM_STORE_TIPS_T_CN                  "是否保存參數到打印機?"
  ...
  #define AXIS_TEST_Z_T_CN                        "Z軸調試"
  #define AXIS_TESTING_Z_T_CN                     "正在進行Z軸調試"

  #define PIDTEMP_SW_TITLE_T_CN                   "加熱模式設置"
  #define PIDTEMP_SW_NMODEL_T_CN                  "普通模式"
  #define PIDTEMP_SW_HMODEL_T_CN                  "高溫模式"
  #define PIDTEMP_SW_NMODEL_CUR_T_CN              "當前加熱模式: 普通模式"
  #define PIDTEMP_SW_HMODEL_CUR_T_CN              "當前加熱模式: 高溫模式"
  #define PIDTEMP_SW_NMODEL_TIP_T_CN              "   按<確定>更改成普通模式.\n(此模式需配置普通噴頭组件使用)"
  #define PIDTEMP_SW_HMODEL_TIP_T_CN              "   按<確定>更改成高溫模式.\n(此模式需配置高溫噴頭组件使用)"
  #define HIGH_HEAT_MODE_T_CN                     "高溫模式"
  #define HIGH_HEAT_MODE_TIPS_T_CN                "高溫模式"
  #define FILAMENT_ADJUST_TEMP_T_CN               "調整溫度"
  #define DIALOG_PRINT_AGAIN_T_CN                 "再次打印"

  #define DEBUG_SELF_CHECK_TITLE_T_CN             "自檢模式"
  #define DEBUG_SELF_CHECK_CONFIRM_T_CN           "檢 測"
  #define DEBUG_SELF_CHECK_CHECKING_T_CN          "正在檢測, 請稍等."
  #define DEBUG_SELF_CHECK_AXIS_SLOW_T_CN         "低速測試"
  #define DEBUG_SELF_CHECK_AXIS_FAST_T_CN         "高速測試"
  #define DEBUG_SELF_CHECK_TIPS_E_TEMP_T_CN       "噴頭溫度"
  #define DEBUG_SELF_CHECK_TIPS_B_TEMP_T_CN       "熱床溫度"
  #define DEBUG_SELF_CHECK_TIPS_E_HEAT_T_CN       "噴頭加熱"
  #define DEBUG_SELF_CHECK_TIPS_B_HEAT_T_CN       "熱床加熱"
  #define DEBUG_SELF_CHECK_TIPS_X_MOTOR_T_CN      "X軸電機"
  #define DEBUG_SELF_CHECK_TIPS_Y_MOTOR_T_CN      "Y軸電機"
  #define DEBUG_SELF_CHECK_TIPS_Z_MOTOR_T_CN      "Z軸電機"
  #define DEBUG_SELF_CHECK_TIPS_E_MOTOR_T_CN      "E軸電機"
  #define DEBUG_SELF_CHECK_TIPS_FAN_T_CN          "風扇"
  #define DEBUG_SELF_CHECK_TIPS_3DTPUCH_T_CN      "3D Touch"
  #define MENU_BUTTON_TIPS_T_CN                   "(點擊切換)"
  #define DIALOG_PRINT_SAVEEXIT_T_CN              "保存並退出"
  #define DIALOG_PRINT_SAVEEXITTIPS_T_CN          "            已使用微移動,\n可使用<保存並退出>保存參數."
#endif
