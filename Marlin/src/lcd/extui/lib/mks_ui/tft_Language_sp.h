...
#define EEPROM_SETTINGS_SP      "Ajuste de fábrica"
...
#define EEPROM_SETTINGS_TITLE_SP  "Ajuste de fábrica"
...
#define EEPROM_SETTINGS_REVERT_SP "Restaurar la configuración de fábrica"

#define EEPROM_STORE_TIPS_SP  "¿Guardar ajustes en EEPROM?"
#define EEPROM_READ_TIPS_SP   "Leer la configuración de EEPROM?"
#define EEPROM_REVERT_TIPS_SP "Restaurar la configuración de fábrica?"
...
#define MORE_CUSTOM7_TEXT_SP  USER_DESC_7
  ...
  #undef EXTRUDER_1_TEXT_SP
  #undef EXTRUDER_2_TEXT_SP
  #undef FILAMENT_EXT0_TEXT_SP
  ...
  #define ADJUST_Z_MENU_ADD_SP                  "Hasta Boquilla"
  #define ADJUST_Z_MENU_DEC_SP                  "Abajo Boquilla"
  #define MENU_WAIT_START_SP                    "A partir del, por favor espere...."
  #define RUNOUT_CONF_TEXT_SP                   "Filamento Detector"
  #define EXTRUDER_1_TEXT_SP                    "Extrusor"
  #define EXTRUDER_2_TEXT_SP                    "Extrusor"
  #define FILAMENT_EXT0_TEXT_SP                 "Extrusor"
  #define FILAMENT_EXT1_TEXT_SP                 "Extrusor"
  #define FILAMENT_DIALOG_LOAD_SELECT_TIPS_SP   "Seleccione el filamento a cargar."
  #define FILAMENT_DIALOG_UNLOAD_SELECT_TIPS_SP "Seleccione el filamento a descargar."
  #define FILAMENT_DIALOG_CLOGGING_SP           "El filamento se está tapando,\nPor favor, limpie la boquilla.\nhaga clic en <confirmar> para volver!"
  #define FILAMENT_SENSOR_ON_SP                 "Filamento\nDetector: On"
  #define FILAMENT_SENSOR_OFF_SP                "Filamento\nDetector: Off"
  #define AUTO_LEVELING_TITLE_SP                "A nivel automático"
  #define AUTO_LEVELING_COMPLETED_SP            "haga clic en <confirmar> para inicio de la nivelautomÃ¡tica"
  #define AUTO_LEVELING_LEVELING_SP             "En nivelautomÃ¡tico, por favor espere!"
  #define AUTO_LEVELING_FINISHED_SP             "Nivel automÃ¡tico completado.\nhaga clic en <confirmar> para volver!\nHaga clic en <ajustar> para Z offset!"
