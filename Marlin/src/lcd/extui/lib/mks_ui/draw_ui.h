...
#define TFT35
    ...
    #define BTN_Y_PIXEL               130   // TFT_screen.btn_y_pixel
    #define BUTTON_POS_X              28
    #define BUTTON_POS_Y              titleHeight
    ...
    #define PARA_UI_BACL_POS_X        (TFT_WIDTH  - PARA_UI_BACK_BTN_X_SIZE - 5)
    #define PARA_UI_BACL_POS_Y        (TFT_HEIGHT - PARA_UI_BACK_BTN_Y_SIZE - 2)

    #define PARA_UI_TURN_PAGE_POS_X   (PARA_UI_BACL_POS_X - PARA_UI_BACK_BTN_X_SIZE - 5)
    #define PARA_UI_TURN_PAGE_POS_Y   PARA_UI_BACL_POS_Y
...
typedef struct {
  ...
  bool  cloud_enable;
  bool  encoder_enable;
  TERN_(MIXWARE_MODEL_V, bool  filament_det_enable;)
  int   levelingPos[5][2];
...
extern lv_point_t line_points[8][2];
