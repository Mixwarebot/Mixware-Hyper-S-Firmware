...
void lv_draw_filament_temperature_select(void) {
  ...
  if (uiCfg.para_ui_page == 0) {
    if (gCfgItems.filament_max_temper > ID_FILAMENT_TEMP_170) lv_screen_menu_item(scr, filament_temp_select.temp_170,  15, PARA_UI_SIZE_Y+78*0, event_handler, ID_FILAMENT_TEMP_170);
    if (gCfgItems.filament_max_temper > ID_FILAMENT_TEMP_180) lv_screen_menu_item(scr, filament_temp_select.temp_180, 167, PARA_UI_SIZE_Y+78*0, event_handler, ID_FILAMENT_TEMP_180);
    if (gCfgItems.filament_max_temper > ID_FILAMENT_TEMP_190) lv_screen_menu_item(scr, filament_temp_select.temp_190,  15, PARA_UI_SIZE_Y+78*1, event_handler, ID_FILAMENT_TEMP_190);
    if (gCfgItems.filament_max_temper > ID_FILAMENT_TEMP_200) lv_screen_menu_item(scr, filament_temp_select.temp_200, 167, PARA_UI_SIZE_Y+78*1, event_handler, ID_FILAMENT_TEMP_200);
    if (gCfgItems.filament_max_temper > ID_FILAMENT_TEMP_210) lv_screen_menu_item(scr, filament_temp_select.temp_210,  15, PARA_UI_SIZE_Y+78*2, event_handler, ID_FILAMENT_TEMP_210);
    if (gCfgItems.filament_max_temper > ID_FILAMENT_TEMP_220) lv_screen_menu_item(scr, filament_temp_select.temp_220, 167, PARA_UI_SIZE_Y+78*2, event_handler, ID_FILAMENT_TEMP_220);
    if (gCfgItems.filament_max_temper > ID_FILAMENT_TEMP_230) lv_screen_menu_item(scr, filament_temp_select.temp_230,  15, PARA_UI_SIZE_Y+78*3, event_handler, ID_FILAMENT_TEMP_230);
    if (gCfgItems.filament_max_temper > ID_FILAMENT_TEMP_240) lv_screen_menu_item(scr, filament_temp_select.temp_240, 167, PARA_UI_SIZE_Y+78*3, event_handler, ID_FILAMENT_TEMP_240);
    if (gCfgItems.filament_max_temper > ID_FILAMENT_TEMP_250) lv_screen_menu_item(scr, filament_temp_select.temp_250,  15, PARA_UI_SIZE_Y+78*4, event_handler, ID_FILAMENT_TEMP_250);
    if (gCfgItems.filament_max_temper > ID_FILAMENT_TEMP_260) lv_screen_menu_item(scr, filament_temp_select.temp_260, 167, PARA_UI_SIZE_Y+78*4, event_handler, ID_FILAMENT_TEMP_260);
    ...
    if (gCfgItems.filament_max_temper > ID_FILAMENT_TEMP_270) lv_screen_menu_item(scr, filament_temp_select.temp_270,  15, PARA_UI_SIZE_Y+78*0, event_handler, ID_FILAMENT_TEMP_270);
    if (gCfgItems.filament_max_temper > ID_FILAMENT_TEMP_280) lv_screen_menu_item(scr, filament_temp_select.temp_280, 167, PARA_UI_SIZE_Y+78*0, event_handler, ID_FILAMENT_TEMP_280);
    if (gCfgItems.filament_max_temper > ID_FILAMENT_TEMP_290) lv_screen_menu_item(scr, filament_temp_select.temp_290,  15, PARA_UI_SIZE_Y+78*1, event_handler, ID_FILAMENT_TEMP_290);
    if (gCfgItems.filament_max_temper > ID_FILAMENT_TEMP_300) lv_screen_menu_item(scr, filament_temp_select.temp_300, 167, PARA_UI_SIZE_Y+78*1, event_handler, ID_FILAMENT_TEMP_300);
    if (gCfgItems.filament_max_temper > ID_FILAMENT_TEMP_310) lv_screen_menu_item(scr, filament_temp_select.temp_310,  15, PARA_UI_SIZE_Y+78*2, event_handler, ID_FILAMENT_TEMP_310);
    if (gCfgItems.filament_max_temper > ID_FILAMENT_TEMP_320) lv_screen_menu_item(scr, filament_temp_select.temp_320, 167, PARA_UI_SIZE_Y+78*2, event_handler, ID_FILAMENT_TEMP_320);
    if (gCfgItems.filament_max_temper > ID_FILAMENT_TEMP_330) lv_screen_menu_item(scr, filament_temp_select.temp_330,  15, PARA_UI_SIZE_Y+78*3, event_handler, ID_FILAMENT_TEMP_330);
    if (gCfgItems.filament_max_temper > ID_FILAMENT_TEMP_340) lv_screen_menu_item(scr, filament_temp_select.temp_340, 167, PARA_UI_SIZE_Y+78*3, event_handler, ID_FILAMENT_TEMP_340);
    if (gCfgItems.filament_max_temper >= ID_FILAMENT_TEMP_350) lv_screen_menu_item(scr, filament_temp_select.temp_350,  15, PARA_UI_SIZE_Y+78*4, event_handler, ID_FILAMENT_TEMP_350);
