...
static const char assets[][LONG_FILENAME_LENGTH] = {
    ...
    MIMG_N_SPEED_RATE_1,
    MIMG_N_SPEED_RATE_5,
    MIMG_N_SPEED_RATE_10,
    MIMG_N_BED,
    MIMG_N_TEMP_RANGE_1,
    MIMG_N_TEMP_RANGE_5,
    MIMG_N_TEMP_RANGE_10,
    MIMG_N_FILAMENT_IN,
    MIMG_N_FILAMENT_OUT,
    MIMG_N_EXT,
    MIMG_N_SPEED_HIGH,
    ...
    MIMG_N_LANG_TCN_SEL,
    MIMG_N_FILAMENT_DET,
    MIMG_N_FILAMENT_DET_ON,
    MIMG_N_FILAMENT_DET_OFF,
    MIMG_N_ARROW,
    MIMG_N_NULL,
    MIMG_N_E_HEAT_M_NORMAL,
    MIMG_N_E_HEAT_M_HIGH,
    MIMG_N_PRINT_HM,
    MIMG_N_PREHEAT_HM,
    MIMG_N_EXT_HM,
    MIMG_N_STATE_EXT_HM,
    MIMG_N_E_HEAT_M_TIP_HM,
    MIMG_N_PREVIEW,
    MIMG_N_LOGO,
    MIMG_N_MIXWARE,
    MIMG_N_ENABLE,
