...
static const char assets[][LONG_FILENAME_LENGTH] = {
  ...
  "img_extruct.bin",
    ...
    "img_bed.bin",
  #endif
  "img_step_degree_1.bin",
  "img_step_degree_5.bin",
  "img_step_degree_10.bin",
  "img_add.bin",
  "img_dec.bin",
  "img_preheat_PLA.bin",
  "img_preheat_PETG.bin",
  "img_preheat_PACF.bin",
  "img_preheat_Bed.bin",
  "img_preheat_Cool.bin",

  //filamentchange screen
  "img_filamentchange_in.bin",
  "img_filamentchange_out.bin",
  ...
  "img_level_4.bin",
  "img_level_5.bin",
  "img_motor_off_all.bin",
  "img_level_z_offset.bin",
  "img_level_auto.bin",
  "img_level_manual.bin",
  "img_save.bin",
  ...
  //lang select screen
    ...
    "img_language.bin",
    "img_language_En.bin",
    "img_language_En_sel.bin",
    "img_language_Es.bin",
    "img_language_Es_sel.bin",
    // "img_language_Fr.bin",
    // "img_language_Fr_sel.bin",
    "img_language_It.bin",
    "img_language_It_sel.bin",
    "img_language_Ru.bin",
    "img_language_Ru_sel.bin",
    "img_language_zh_CN.bin",
    "img_language_zh_CN_sel.bin",
    "img_language_zh_TW.bin",
    "img_language_zh_TW_sel.bin",
