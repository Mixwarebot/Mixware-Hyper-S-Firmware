...
#define MTR_ADVSET_PAUSE_POSITION_X_TCN      MTR_X "軸暫停位置(絶對位置)"
#define MTR_ADVSET_PAUSE_POSITION_Y_TCN      MTR_Y "軸暫停位置(絶對位置)"
#define MTR_ADVSET_PAUSE_POSITION_Z_TCN      MTR_Z "軸暫停位置(相對位置)"
#define MTR_ADVSET_PAUSE_POSITION_TIPS_TCN   "(提示: -1 無效.)"
