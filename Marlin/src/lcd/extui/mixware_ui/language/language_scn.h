...
#define MTR_ADVSET_PAUSE_POSITION_X_SCN      MTR_X "轴暂停位置(绝对位置)"
#define MTR_ADVSET_PAUSE_POSITION_Y_SCN      MTR_Y "轴暂停位置(绝对位置)"
#define MTR_ADVSET_PAUSE_POSITION_Z_SCN      MTR_Z "轴暂停位置(相对位置)"
#define MTR_ADVSET_PAUSE_POSITION_TIPS_SCN   "(提示: -1 无效.)"
