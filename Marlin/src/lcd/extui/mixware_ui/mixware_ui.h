...
typedef struct
{
  int16_t max_heating_mode_temp;                // normal mode: 260c high mode: 350c
...
public:
  ...
  inline void set_heating_mode_temperature(int16_t temp) { info.preference.param.max_heating_mode_temp = temp; }
  inline int16_t get_heating_mode_temperature() { return info.preference.param.max_heating_mode_temp; }
