...
#include "../../../core/debug_out.h"
  ...
  #include "../../../lcd/extui/mixware_ui/mixware_ui.h"
#endif
...
G29_TYPE GcodeSuite::G29() {
  ...
  if (planner.leveling_active) sync_plan_position();
    ...
    planner.synchronize();
      ...
      if (mixware_ui.get_auto_leveling_state() == LEVEL_STATE_LEVELERR) {
        process_subcommands_now_P(PSTR("G28\nM502\nM500"));
      }
      else {
        process_subcommands_now_P(PSTR(Z_PROBE_END_SCRIPT));
        mixware_ui.set_auto_leveling_state(LEVEL_STATE_FINISHED);
      }
    #else
      process_subcommands_now_P(PSTR(Z_PROBE_END_SCRIPT));
    #endif
